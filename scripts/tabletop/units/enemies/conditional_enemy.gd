...
## [param condition]: Must be a function taking [Tabletop] as a parameter and returning a [b]boolean[/b] and should [b]NOT[/b] have side effects[br]
...
func _on_turn(tabletop: Tabletop):
    ...
    while true:
        ...
        for behavior in _behaviors:
            var condition_result = behavior.condition.call(tabletop)
